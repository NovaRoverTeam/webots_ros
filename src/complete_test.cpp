...
void radarTargetsCallback(const webots_ros::RadarTarget::ConstPtr& target) {
  ROS_INFO("Received a radar target with distance=%lf received power=%lf speed=%lf azimuth=%lf (time: %d:%d).", target->distance, target->receivedPower, target->speed, target->azimuth, target->header.stamp.sec, target->header.stamp.nsec);
}

void radarTargetsNumberCallback(const webots_ros::Int8Stamped::ConstPtr& value) {
  ROS_INFO("Number of target seen by the radar: %d (time: %d:%d).", value->data, value->header.stamp.sec, value->header.stamp.nsec);
}
...
void accelerometerCallback(const sensor_msgs::Imu::ConstPtr& values) {
  ...
  ROS_INFO("Accelerometer values are x=%f y=%f z=%f (time: %d:%d).", accelerometerValues[0], accelerometerValues[1], accelerometerValues[2], values->header.stamp.sec, values->header.stamp.nsec);
}
...
void compassCallback(const sensor_msgs::MagneticField::ConstPtr& values) {
  ...
  ROS_INFO("Compass values are x=%f y=%f z=%f (time: %d:%d).", compassValues[0], compassValues[1], compassValues[2], values->header.stamp.sec, values->header.stamp.nsec);
}
...
void GPSCallback(const sensor_msgs::NavSatFix::ConstPtr& values) {
  ...
  ROS_INFO("GPS values are x=%f y=%f z=%f (time: %d:%d).", GPSValues[0], GPSValues[1], GPSValues[2], values->header.stamp.sec, values->header.stamp.nsec);
}
...
void gyroCallback(const sensor_msgs::Imu::ConstPtr& values) {
  ...
  ROS_INFO("Gyro values are x=%f y=%f z=%f (time: %d:%d).", GyroValues[0], GyroValues[1], GyroValues[2], values->header.stamp.sec, values->header.stamp.nsec);
}
...
void inertialUnitCallback(const sensor_msgs::Imu::ConstPtr& values) {
  ...
  ROS_INFO("Inertial unit values (quaternions) are x=%f y=%f z=%f w=%f (time: %d:%d).",inertialUnitValues[0],inertialUnitValues[1],inertialUnitValues[2],inertialUnitValues[2], values->header.stamp.sec, values->header.stamp.nsec);
}
...
void touchSensor3DCallback(const geometry_msgs::WrenchStamped::ConstPtr& values) {
  ...
  ROS_INFO("Touch sensor values are x = %f, y = %f and z = %f (time: %d:%d).", touchSensorValues[0], touchSensorValues[1], touchSensorValues[2], values->header.stamp.sec, values->header.stamp.nsec);
}
...
int main(int argc, char **argv) {
  ...
  ros::ServiceClient get_number_of_devices_client = n.serviceClient<webots_ros::get_int>(model_name+"/robot/get_number_of_devices");
  ...
  ros::ServiceClient device_list_client = n.serviceClient<webots_ros::robot_get_device_list>(model_name+"/robot/get_device_list");
  ...
  ros::ServiceClient get_basic_time_step_client = n.serviceClient<webots_ros::get_float>(model_name+"/robot/get_basic_time_step");
  ...
  ros::ServiceClient get_controller_arguments_client = n.serviceClient<webots_ros::get_string>(model_name+"/robot/get_controller_arguments");
  ...
  ros::ServiceClient get_controller_name_client = n.serviceClient<webots_ros::get_string>(model_name+"/robot/get_controller_name");
  ...
  ros::ServiceClient robot_get_custom_data_client = n.serviceClient<webots_ros::get_string>(model_name+"/robot/get_custom_data");
  ...
  ros::ServiceClient get_synchronization_client = n.serviceClient<webots_ros::get_bool>(model_name+"/robot/get_synchronization");
  ...
  ros::ServiceClient robot_set_custom_data_client = n.serviceClient<webots_ros::set_string>(model_name+"/robot/set_custom_data");
  ...
  ros::ServiceClient wait_for_user_input_event_client = n.serviceClient<webots_ros::robot_wait_for_user_input_event>(model_name+"/robot/wait_for_user_input_event");
  ...
  ros::ServiceClient brake_get_motor_name_client = n.serviceClient<webots_ros::get_string>(model_name+"/my_brake/get_motor_name");
  ...
  if (brake_get_motor_name_client.call(brake_get_motor_name_srv)) {
    ...
    if (brake_get_motor_name_srv.response.value.compare("linear_motor") != 0)
      ROS_ERROR("Failed to call service brake_get_motor_name: received '%s' instead of 'linear_motor'", brake_get_motor_name_srv.response.value.c_str());
  } else
  ...
  if (get_info_client.call(get_info_srv))
    ROS_INFO("Camera of %s has a width of %d, a height of %d, a field of view of %f, a near range of %f.", model_name.c_str(), get_info_srv.response.width, get_info_srv.response.height, get_info_srv.response.Fov, get_info_srv.response.nearRange);
  else
  ...
  if (get_info_client.call(camera_get_focus_info_srv))
    ROS_INFO("Camera of %s has focalLength %f, focalDistance %f, maxFocalDistance %f, and minFocalDistance %f.", model_name.c_str(), camera_get_focus_info_srv.response.focalLength, camera_get_focus_info_srv.response.focalDistance, camera_get_focus_info_srv.response.maxFocalDistance, camera_get_focus_info_srv.response.minFocalDistance);
  else
  ...
  if (get_info_client.call(camera_get_zoom_info_srv))
    ROS_INFO("Camera of %s has min fov %f, anf max fov %f.", model_name.c_str(), camera_get_zoom_info_srv.response.minFov, camera_get_zoom_info_srv.response.maxFov);
  else
  ...
  sampling_period_accelerometer_client = n.serviceClient<webots_ros::get_int>(model_name+"/accelerometer/get_sampling_period");
  ...
  sampling_period_battery_sensor_client = n.serviceClient<webots_ros::get_int>(model_name+"/battery_sensor/get_sampling_period");
  ...
  if (connector_enable_presence_client.call(connector_srv) && connector_srv.response.success) {
    ...
    while (sub_connector.getNumPublishers() == 0) {
      ros::spinOnce();
      time_step_client.call(time_step_srv);
    }
  } else {
  ...
  sampling_period_distance_sensor_client = n.serviceClient<webots_ros::get_int>(model_name+"/distance_sensor/get_sampling_period");
  ...
  sampling_period_inertial_unit_client = n.serviceClient<webots_ros::get_int>(model_name+"/inertial_unit/get_sampling_period");
  ...
  if (enable_joystick_client.call(enable_joystick_srv) && enable_joystick_srv.response.success) {
    ...
    while (sub_joystick.getNumPublishers() == 0) {
      ros::spinOnce();
      time_step_client.call(time_step_srv);
    }
  ...
  if (set_lidar_client.call(lidar_srv) && lidar_srv.response.success) {
    ...
    while (sub_lidar.getNumPublishers() == 0) {
      ros::spinOnce();
      time_step_client.call(time_step_srv);
    }
  ...
  if (get_info_client.call(get_lidar_info_srv))
    ROS_INFO("Lidar of %s has a horizontal resolution of %d, %d layers, a field of view of %f, a min range of %f and a max range of %f.", model_name.c_str(), get_lidar_info_srv.response.horizontalResolution, get_lidar_info_srv.response.numberOfLayers, get_lidar_info_srv.response.fov, get_lidar_info_srv.response.minRange, get_lidar_info_srv.response.maxRange);
  else
  ...
  if (get_info_client.call(get_lidar_frequency_info_srv))
    ROS_INFO("Lidar %s current frequency is %f, maximum frequency is %f and minimum frequency is %f.", model_name.c_str(), get_lidar_frequency_info_srv.response.frequency, get_lidar_frequency_info_srv.response.maxFrequency, get_lidar_frequency_info_srv.response.minFrequency);
  else
  ...
  if (motor_get_brake_name_client.call(motor_get_brake_name_srv)) {
    ...
    if (motor_get_brake_name_srv.response.value.compare("my_brake") != 0)
      ROS_ERROR("Failed to call service motor_get_brake_name: received '%s' instead of 'my_brake'", motor_get_brake_name_srv.response.value.c_str());
  } else
  ...
  set_linear_control_pid_client = n.serviceClient<webots_ros::motor_set_control_pid>(model_name+"/linear_motor/set_control_pid");
  ...
  sampling_period_position_sensor_client = n.serviceClient<webots_ros::get_int>(model_name+"/position_sensor/get_sampling_period");
  ...
  if (set_radar_client.call(radar_srv) && radar_srv.response.success) {
    ...
    while (sub_radar_target.getNumPublishers() == 0 && sub_radar_target_number.getNumPublishers() == 0) {
      ros::spinOnce();
      time_step_client.call(time_step_srv);
    }
  ...
  if (set_range_finder_client.call(range_finder_srv) && range_finder_srv.response.success) {
    ...
    while (sub_range_finder_color.getNumPublishers() == 0) {
      ros::spinOnce();
      time_step_client.call(time_step_srv);
    }
  ...
  if (get_info_client.call(get_range_finder_info_srv))
    ROS_INFO("Range-finder of %s has a width of %d, a height of %d, a field of view of %f, a min range of %f and a max range of %f.", model_name.c_str(), get_range_finder_info_srv.response.width, get_range_finder_info_srv.response.height, get_range_finder_info_srv.response.Fov, get_range_finder_info_srv.response.minRange, get_range_finder_info_srv.response.maxRange);
  else
  ...
  receiver_get_emitter_direction_client = n.serviceClient<webots_ros::receiver_get_emitter_direction>(model_name+"/receiver/get_emitter_direction");
  ...
  supervisor_simulation_reset_physics_client = n.serviceClient<webots_ros::get_bool>(model_name+"/supervisor/simulation_reset_physics");

  if (supervisor_simulation_reset_physics_client.call(supervisor_simulation_reset_physics_srv) && supervisor_simulation_reset_physics_srv.response.value)
  ...
  supervisor_get_from_def_client = n.serviceClient<webots_ros::supervisor_get_from_def>(model_name+"/supervisor/get_from_def");
  ...
  supervisor_node_get_type_name_client = n.serviceClient<webots_ros::node_get_name>(model_name+"/supervisor/node/get_type_name");
  ...
  supervisor_node_get_base_type_name_client = n.serviceClient<webots_ros::node_get_name>(model_name+"/supervisor/node/get_base_type_name");
  ...
  supervisor_node_get_position_client = n.serviceClient<webots_ros::node_get_position>(model_name+"/supervisor/node/get_position");
  ...
  ROS_INFO("From_def node got position: x = %f y = %f z = %f.",
    supervisor_node_get_position_srv.response.position.x,
    supervisor_node_get_position_srv.response.position.y,
    supervisor_node_get_position_srv.response.position.z);
  ...
  supervisor_node_get_orientation_client = n.serviceClient<webots_ros::node_get_orientation>(model_name+"/supervisor/node/get_orientation");
  ...
  ROS_INFO("From_def orientation quaternion is:\nw=%f x=%f y=%f z=%f.",
    supervisor_node_get_orientation_srv.response.orientation.w,
    supervisor_node_get_orientation_srv.response.orientation.x,
    supervisor_node_get_orientation_srv.response.orientation.y,
  ...
  supervisor_node_get_center_of_mass_client = n.serviceClient<webots_ros::node_get_center_of_mass>(model_name+"/supervisor/node/get_center_of_mass");
  ...
  supervisor_node_get_number_of_contact_points_client = n.serviceClient<webots_ros::node_get_number_of_contact_points>(model_name+"/supervisor/node/get_number_of_contact_points");
  ...
  supervisor_node_get_contact_point_client = n.serviceClient<webots_ros::node_get_contact_point>(model_name+"/supervisor/node/get_contact_point");
  ...
  ROS_INFO("From_def_node first contact point is at x = %f, y = %f z = %f.",
    supervisor_node_get_contact_point_srv.response.point.x,
    supervisor_node_get_contact_point_srv.response.point.y,
  ...
  supervisor_node_get_static_balance_client = n.serviceClient<webots_ros::node_get_static_balance>(model_name+"/supervisor/node/get_static_balance");
  ...
  // test reset_physics
  // if the node isn't a top Solid webots will throw a warning but still return true to ros
  ros::ServiceClient supervisor_node_reset_physics_client = n.serviceClient<webots_ros::node_reset_functions>(model_name+"/supervisor/node/reset_physics");
  ...
  ros::ServiceClient supervisor_node_restart_controller_client = n.serviceClient<webots_ros::node_reset_functions>(model_name+"/supervisor/node/restart_controller");
  ...
  if (supervisor_node_restart_controller_client.call(supervisor_node_restart_controller_srv) && supervisor_node_restart_controller_srv.response.success == 1)
  ...
  supervisor_field_get_type_name_client = n.serviceClient<webots_ros::field_get_type_name>(model_name+"/supervisor/field/get_type_name");
  ...
  supervisor_field_set_string_client = n.serviceClient<webots_ros::field_set_string>(model_name+"/supervisor/field/set_string");
  ...
  supervisor_field_get_string_client = n.serviceClient<webots_ros::field_get_string>(model_name+"/supervisor/field/get_string");
  ...
  node_get_parent_node_client = n.serviceClient<webots_ros::node_get_parent_node>(model_name+"/supervisor/node/get_parent_node");
  ...
  if (supervisor_movie_is_ready_client.call(supervisor_movie_is_ready_srv) && supervisor_movie_is_ready_srv.response.status == 1)
  ...
  supervisor_movie_start_client = n.serviceClient<webots_ros::supervisor_movie_start_recording>(model_name+"/supervisor/movie_start_recording");
  ...
  if (wwi_receive_client.call(wwi_receive_srv) && wwi_receive_srv.response.value.compare("Answer: test wwi functions from complete_test controller.") == 0)
  ...
  virtual_reality_headset_client = n.serviceClient<webots_ros::get_bool>(model_name+"/supervisor/vitual_reality_headset_is_used");
  ...
  // test field_import_node
    // this test is disabled as it needs a webots object file but it will work if you export the cone_test solid from the world before
    //  ros::ServiceClient supervisor_field_import_node_client;
    //  webots_ros::field_import_node supervisor_field_import_node_srv;
    //  supervisor_field_import_node_client = n.serviceClient<webots_ros::field_import_node>(model_name+"/supervisor/field/import_node");
    //
  ...
  //~ if (supervisor_simulation_quit_client.call(supervisor_simulation_quit_srv) && supervisor_simulation_quit_srv.response.success)
  ...
  //~
  //~ if (supervisor_simulation_revert_client.call(supervisor_simulation_revert_srv) && supervisor_simulation_revert_srv.response.value)
