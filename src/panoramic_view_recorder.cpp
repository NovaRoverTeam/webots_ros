...
int main(int argc, char **argv) {
  ...
  // get children list
  ros::ServiceClient getWorldChildrenClient = n.serviceClient<webots_ros::node_get_field>(controllerName+"/supervisor/node/get_field");
  ...
  // get spotlight node
  ros::ServiceClient getSpotlightClient = n.serviceClient<webots_ros::field_get_node>(controllerName+"/supervisor/field/get_node");
  ...
  ros::ServiceClient getSpotlightPositionFieldClient = n.serviceClient<webots_ros::node_get_field>(controllerName+"/supervisor/node/get_field");
  ...
  ros::ServiceClient getPositionClient = n.serviceClient<webots_ros::field_get_vec3f>(controllerName+"/supervisor/field/get_vec3f");
  ...
  ros::ServiceClient getSpotlightOrientationFieldClient = n.serviceClient<webots_ros::node_get_field>(controllerName+"/supervisor/node/get_field");
  ...
  ros::ServiceClient getOrientationClient = n.serviceClient<webots_ros::field_get_vec3f>(controllerName+"/supervisor/field/get_vec3f");
  ...
  ROS_INFO("Initial position of spotlight is %f %f %f and its orientation is %f %f %f.", initialSpotPosition.x, initialSpotPosition.y, initialSpotPosition.z, spotOrientation.x, spotOrientation.y, spotOrientation.z);

  // initialize services to update spotlight position and orientation
  ros::ServiceClient setPositionClient = n.serviceClient<webots_ros::field_set_vec3f>(controllerName+"/supervisor/field/set_vec3f");
  ...
  ros::ServiceClient setOrientationClient = n.serviceClient<webots_ros::field_set_vec3f>(controllerName+"/supervisor/field/set_vec3f");
  ...
  ros::ServiceClient getPovPositionFieldClient = n.serviceClient<webots_ros::node_get_field>(controllerName+"/supervisor/node/get_field");
  ...
  ros::ServiceClient getPovOrientationFieldClient = n.serviceClient<webots_ros::node_get_field>(controllerName+"/supervisor/node/get_field");
  ...
  ros::ServiceClient getPovOrientationClient = n.serviceClient<webots_ros::field_get_rotation>(controllerName+"/supervisor/field/get_rotation");
  ...
  ROS_INFO("Initial position of point of view is %f %f %f and its orientation is %f %f %f %f.", initialPovPosition.x, initialPovPosition.y, initialPovPosition.z, povOrientation.x, povOrientation.y, povOrientation.z, povOrientation.w);
  ...
  ros::ServiceClient setPovOrientationClient = n.serviceClient<webots_ros::field_set_rotation>(controllerName+"/supervisor/field/set_rotation");
  ...
  supervisorMovieStartClient = n.serviceClient<webots_ros::supervisor_movie_start_recording>(controllerName+"/supervisor/movie_start_recording");
