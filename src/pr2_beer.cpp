...
int main(int argc, char **argv)
{
  ...
  fllWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/fl_caster_l_wheel_joint/set_acceleration");
  flrWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/fl_caster_r_wheel_joint/set_acceleration");
  frlWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/fr_caster_l_wheel_joint/set_acceleration");
  frrWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/fr_caster_r_wheel_joint/set_acceleration");
  bllWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/bl_caster_l_wheel_joint/set_acceleration");
  blrWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/bl_caster_r_wheel_joint/set_acceleration");
  brlWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/br_caster_l_wheel_joint/set_acceleration");
  brrWheelAccelerationClient = n.serviceClient<webots_ros::set_float>(controllerName + "/br_caster_r_wheel_joint/set_acceleration");
  ...
  fllWheelSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/fl_caster_l_wheel_joint/position_sensor/set_sensor");
  flRotationSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/fl_caster_rotation_joint/position_sensor/set_sensor");
  torsoSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/torso_lift_joint/position_sensor/set_sensor");
  llFingerSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/l_gripper_l_finger_joint/position_sensor/set_sensor");
  rrFingerSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/r_gripper_r_finger_joint/position_sensor/set_sensor");
  lShoulderSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/l_shoulder_pan_joint/position_sensor/set_sensor");
  rShoulderSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/r_shoulder_pan_joint/position_sensor/set_sensor");
  lBumperSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/r_gripper_l_finger_tip_contact_sensor/set_sensor");
  rBumperSetClient = n.serviceClient<webots_ros::sensor_set>(controllerName + "/l_gripper_l_finger_tip_contact_sensor/set_sensor");
  ...
  ros::Subscriber fllWheelSubscriber = n.subscribe(controllerName + "/fl_caster_l_wheel_joint/position_sensor/32", 1, fllWheelCallback);
  ros::Subscriber flRotationSubscriber = n.subscribe(controllerName + "/fl_caster_rotation_joint/position_sensor/32", 1, flRotationCallback);
  ...
  while (ros::ok()) {
    ...
    else if (wheelPosition < 46.5 && sequence < 7)
    {
      if (sequence == 5)
      {
        ...
        rBumperSubscriber = n.subscribe(controllerName + "/r_gripper_l_finger_tip_contact_sensor/32_bumper", 1, rBumperCallback);
        move(FWD_SPEED/3);
      }
      sequence = 6;
    }
    ...
    else if (wheelPosition < 50.5 && sequence < 16)
    {
      if (sequence == 14)
      {
        ...
        lBumperSubscriber = n.subscribe(controllerName + "/l_gripper_l_finger_tip_contact_sensor/32_bumper", 1, lBumperCallback);
        move(FWD_SPEED/3);
      }
      sequence = 15;
    }
    ...
    else if ( rShoulderPosition < 0.5 && sequence < 21)
    {
      if (sequence == 19)
      {
        ...
        lElbowLiftClient.call(lElbowLiftSrv);
        flRotationSetClient.call(setSensorSrv);
        flRotationSubscriber = n.subscribe(controllerName + "/fl_caster_rotation_joint/position_sensor/32", 1, flRotationCallback);
      }
      sequence = 20;
    }
